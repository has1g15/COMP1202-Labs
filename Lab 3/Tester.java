...
public class Tester {
    ...
    public static void testPart3() {
        ...
        System.out.println("======");
        Door door = new Door();             //Creates a new door 
        door.setRoomName("Research Labs");  //Sets room name 
        CardLock cl = new CardLock();       //Creates card lock 
        door.attachLock(cl);
        System.out.println("Card Lock attached to door");
        SmartCard sc = new SmartCard("Hannah");     //New student smart card 
        cl.swipeCard(sc);                           //Student smart card swiped on the card lock 
        System.out.println("Card Swiped");
        door.openDoor();
        sc.setStaff(true);                          //Smart card set as staff smart card 
        System.out.println("Smart card belongs to staff");
        cl.swipeCard(sc);
        System.out.println("Card swiped");
        door.openDoor();
